...
메인 화면 상단의 현재 브리핑 기준은 수기로 입력하지 않습니다. 접속한 날짜를 기준으로 `2026년 5월 2주` 형식으로 자동 표시됩니다. 주차 기준은 일요일부터 시작하는 달력에서 해당 날짜가 몇 번째 줄에 있는지를 따릅니다. 예를 들어 2026년 6월 7일은 달력의 두 번째 줄에 있으므로 `2026년 6월 2주`로 표시됩니다.
